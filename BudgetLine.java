...
final class BudgetLine extends DataStorage {
    private long id;
    ...
    BudgetLine() {
	//System.out.println("BudgetLine constructor");
    }
	...
	//System.out.println("New BudgetLine created:");
...
//	System.out.println("BudgetLine Userdump");
//    }
...
// --Recycle Bin STOP (2003-12-27 18:33)
    ...
    public void DOMexport(final Document document, final Node root) {
        ...
        final Node budgetLine;
	
	budgetLine = document.createElement("BudgetLine");

	addNodeDOM(document, budgetLine, "Id", id);
	addNodeDOM(document, budgetLine, "Category", category);
	addNodeDOM(document, budgetLine, "Frequency", frequency);
	addNodeDOM(document, budgetLine, "StartMonth", startMonth);
	addNodeDOM(document, budgetLine, "verNumb", verNumb);

	for(int i=0; i<12; i++) {
	    addNodeDOM(document, budgetLine, "Month"+i, values[i]);
	}
